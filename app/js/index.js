...
$('.tab-list').each(function () {
    ...
    $this.on('click', '.tab-control', function (e) {
        ...
        if (id && !$link.is('active')) {
            $('.slide-viewer')
                .animate({ //fade out current panel contents on tab clcik to prime for fade in.
                    opacity: 0
...
$(function () {
    ...
    // Callback function references the event target and adds the 'swipeleft' class
    // to it
...
function moveProgressBar() {
    ...
    // on page load, animate percentage bar to data percentage length .stop() used
    // to prevent animation queueing
    $('.progress-bar')
        .stop()
        .animate({
            left: progressTotal
